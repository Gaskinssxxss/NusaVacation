<template>
    <div>
        <div class="pl-7 md:pl-26 pr-1 md:pr-16 pb-20">
            <div class="bg-black">
                    ...
                    <div class="py-[0.5px]">
                        ...
                        <div>
                            <div class="bg-sunny border-t-2 border-black h-[600px]" style="overflow-y: auto;">
                                <div
                                    class="-ml-1 sm: inline-block sm:flex justify-around items-center pb-10 pt-8 sm:pt-16 px-8 sm:px-10 font-Karantina text-4xl sm:text-5xl tracking-wide font-bold">
                                    <div>
                                        <div class="bg-black">
            ...
            <div v-show="tour" class="relative -top-[560px] sm:-top-[520px] 3xl:-top-[620px] -mb-40">
                                ...
                                <div>
                                    <div
                                        ...
                                        <h1 class="font-Karantina font-bold pb-2">
                                            ...
                                            velit
                                            earum
                                            voluptas excepturi quod nulla? Dolore unde sunt eum. Id ipsa dignissimos
                                            exercitationem quidem soluta provident error delectus labore?Lorem, ipsum
            ...
            <div v-show="tick" class="relative -top-[560px] sm:-top-[520px] 3xl:-top-[620px] -mb-40">
                <div class="flex justify-center">
                    <div class="flex pb-16 w-[310px] sm:w-105 h-40 pt-10 3xl:pt-4">
                        <div>
                            <div>
